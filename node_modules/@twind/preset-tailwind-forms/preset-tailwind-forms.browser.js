...
let [baseFontSize, baseLineHeight] = defaultTheme.fontSize.base, { spacing , borderWidth , borderRadius  } = defaultTheme;
function presetTailwindForms({ strategy  } = {}) {
    ...
    return 'base' !== strategy && (config.rules = [
        [
            ...
            (match, context)=>{
                return {
                    '@layer base': rules.filter((r)=>{
                        var _r_c;
                        return null == (_r_c = r.c) ? void 0 : _r_c.includes(match[1]);
...
let rules = [
    ...
    },
    {
        ...
        s: ({ theme  })=>({
                'background-image': `url("${svgToDataUri(`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20"><path stroke="${toColorValue(theme('colors.gray.500', gray[500]))}" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M6 8l4 4 4-4"/></svg>`)}")`,
...
export { presetTailwindForms as default };
//# sourceMappingURL=preset-tailwind-forms.browser.js.map
